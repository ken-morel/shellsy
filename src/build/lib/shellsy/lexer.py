            ...
            | {
                ...
                "shellsy-statement": [
                    *[
                        (
                            r"("
                            + command.replace(".__entrypoint__", "").replace(
                                ".", "\\."
                            )
                            + "\\b)",
                            Name.Function,
                        )
                        for command in shell.get_possible_subcommands()
                    ],
                    *[(f"\\b{c}\\b", Keyword) for c in Word.words.keys()],
                    (
                        r"^(\$)([\w_]+)\s*(\:?)",
